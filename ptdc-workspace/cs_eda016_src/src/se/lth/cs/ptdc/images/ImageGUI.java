...
public class ImageGUI {
	...
	/**
	 * Convert a BufferedImage to a Color matrix. Called once every time a new
	...
	/**
	 * Convert a Color matrix to a BufferedImage
	 */
	...
	class ImageFrame extends JFrame implements ActionListener {
		...
		public ImageFrame() {
			...
			getContentPane().add(new JScrollPane(drawingArea),
					BorderLayout.CENTER);
		...
		class DrawingArea extends JPanel {
			...
			public void paintComponent(Graphics g) {
				...
				if (filteredImage != null) {
					g2.drawImage(filteredImage, null,
							originalImage.getWidth() + 5, 0);
		...
		class ToolPanel extends JPanel implements ActionListener {
			private static final long serialVersionUID = 1;
			private JComboBox cbMethod; // the combo box
			...
			public ToolPanel() {
				...
				cbMethod = new JComboBox(methods);
